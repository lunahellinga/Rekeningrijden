...
grafana:
  ...
  grafana.ini:
    ...
    auth.generic_oauth:
      ...
      auth_url: https://keycloak.$DNSMASQ_DOMAIN/realms/master/protocol/openid-connect/auth
      token_url: https://keycloak.$DNSMASQ_DOMAIN/realms/master/protocol/openid-connect/token
      api_url: https://keycloak.$DNSMASQ_DOMAIN/realms/master/protocol/openid-connect/userinfo
      client_id: grafana
